...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm overflow-hidden p-6">
        ...
        <form action="{{ route('admin.packages.store') }}" 
            ...
            <!-- Services Inclus -->
            <div x-data="{ services: {{ json_encode(old('included_services', [])) }}, newService: '' }">
            ...
            <!-- Services Exclus -->
            <div x-data="{ services: {{ json_encode(old('excluded_services', [])) }}, newService: '' }">
            ...
            <div class="flex justify-end space-x-3 pt-6">
                ...
                <button type="submit" 
                        class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200">
